...
require github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.12.14
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.6.14 // indirect
